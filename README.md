...
![Home Page](Features/home%20page.png)

### Document Upload

Clean and intuitive interface for uploading text documents.

![Upload Page](Features/Upload%20page.png)

### Page-Based Navigation

Smooth page navigation with intelligent preloading for seamless reading experience.

![Page Navigation](Features/Page%20navigation.png)

### Inline Explanations (≤3 words)

Quick tooltip explanations appear directly above selected text for short selections.

![Inline Explanation](Features/inline%20explanation.png)

### Sidebar Explanations (>3 words)

Detailed explanations in a fixed sidebar for longer text selections without disrupting reading flow.

![Sidebar Explanation](Features/Sidebar%20explanation.png)
...
│   │   ├── services/       # API clients and cache management
│   │   └── ...
│   └── package.json
...
│   │   └── database/       # SQLite database (documents.db)
