...
- [ ] 2.5 Add document list display (Not done)
...
## Phase 3: Reading Interface(done, but need to adjust the UI)
...
- [ ] 4.1 Configure OpenAI API integration (almost done, but rate limiting no)
...
- [ ] 4.2 Create explanation generation endpoint(done)
